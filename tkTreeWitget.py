...
class McListBox(object):
    ...
    def __init__(self,master,headers,rows=None):
        self.master = master
    ...
    def build_values(self,items_list):
...
if __name__ == "__main__":
    ...
    #mc_listbox = McListBox(root,car_header,car_list)
    mc_listbox = McListBox(root,val_types)
    # mc_listbox.build_values(vals)
